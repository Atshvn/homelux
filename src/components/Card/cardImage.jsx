...
export function PrimaryCard({ primaryContainer, miniModal, fakeProfiles }) {
  ...
  return (
    <div
      className="w-11/12 max-w-[380px] sm:max-w-[480px] md:w-full md:max-w-none lg:w-11/12 p-5 
    relative z-10 after:bg-tertiary-200 after:w-full after:h-[85%] after:absolute after:inset-0 after:z-0 sm:p-8 md:p-4 lg:p-10"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
...
export function SecondaryCard({ primaryContainer }) {
  ...
  return (
    <div
      className="w-11/12 max-w-[380px] sm:max-w-[480px] md:w-full md:max-w-none lg:w-11/12 p-5 
   relative z-10 after:bg-secondary-200 0 after:w-full after:h-[85%] after:absolute after:inset-0 after:z-0 sm:p-8 md:p-4 lg:p-10"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
